    ...
    public:
        ...
        struct boss_deathbringer_saurfangAI : public BossAI
        {
            ...
            void Reset()
            {
                ...
                summons.DespawnAll();
                instance->SetData(DATA_DEATHBRINGER_SAURFANG, NOT_STARTED);
            }
            ...
            void MovementInform(uint32 type, uint32 id)
            {
                ...
                instance->HandleGameObject(instance->GetData64(SAURFANG_DOOR), false);
            }
            ...
            void DoAction(const int32 action)
            {
                if (action == ACTION_START_EVENT)
                {
                    ...
                    if (pInstance)
                    {
                        ...
                        pInstance->HandleGameObject(pInstance->GetData64(SAURFANG_DOOR), true);
                    }
