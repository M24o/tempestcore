...
char serviceName[] = "MythRealm";
char serviceLongName[] = "MythRealm service";
char serviceDescription[] = "Myth Project WoW Server";
 /*
...
extern int main(int argc, char **argv)
{
    ...
    sLog.outString( "                      \\/_/" );
    sLog.outString( "" );
    sLog.outString( "* Open-Source * Power Of the Community *" );
