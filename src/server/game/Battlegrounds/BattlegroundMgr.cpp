...
BattlegroundMgr::BattlegroundMgr() : m_AutoDistributionTimeChecker(0), m_ArenaTesting(false), m_OPvPTesting(false)
{
...
void BattlegroundMgr::ToggleOPvPTesting()
{
    m_OPvPTesting = !m_OPvPTesting;
    if (m_OPvPTesting)
        sWorld.SendWorldText(LANG_DEBUG_OPVP_ON);
    else
        sWorld.SendWorldText(LANG_DEBUG_OPVP_OFF);
}
