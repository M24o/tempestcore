...
enum TrinityStrings
{
    ...
    LANG_BG_IC_START_TWO_MINUTES        = 639,
    LANG_BG_IC_START_ONE_MINUTE         = 640,
    LANG_BG_IC_START_HALF_MINUTE        = 641,
    LANG_BG_IC_HAS_BEGUN                = 642,
    ...
    LANG_BG_IC_ALLY                     = 662,
    LANG_BG_IC_HORDE                    = 663,
    LANG_BG_IC_NODE_WORKSHOP            = 664,
    LANG_BG_IC_NODE_QUARRY              = 665,
    LANG_BG_IC_NODE_REFINERY            = 666,
    LANG_BG_IC_NODE_DOCKS               = 667,
    LANG_BG_IC_NODE_HANGAR              = 668,
...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    LANG_BG_WG_SWITCH_CASTLE_OWNERS     = 774,

    // Room for BG/ARENA                = 775-779, 782-784, 788-799 not used
    ...
    LANG_DEBUG_OPVP_ON                  = 819,
    LANG_DEBUG_OPVP_OFF                 = 820,
