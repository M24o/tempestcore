...
UPDATE `trinity_string` SET `content_default` = 'The Wintergrasp fortress has been captured by %s !', `content_loc2` = '%s a capturé la forteresse du Joug d''hiver !' WHERE `entry` =12072 LIMIT 1;
